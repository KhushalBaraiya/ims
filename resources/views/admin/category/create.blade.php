...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-1">{{ isset($category) ? __('admin.edit_category') : __('admin.add_category') }}</h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 fs-6">
                    <li class="breadcrumb-item"><a
                            href="{{ route('admin.dashboard') }}">{{ __('admin.breadcrumb_dashboard') }}</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('admin.category.index') }}">{{ __('admin.categories') }}</a>
                    </li>
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white py-3 border-bottom">
                        <h6 class="mb-0 fw-semibold fs-5"><i
                                class="bx bx-category me-2 text-primary"></i>{{ __('admin.category_details') }}
                        </h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control form-control-lg"
                                placeholder="{{ __('admin.ph_category_name') }}"
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                ...
                                {{ isset($category) ? __('admin.update') : __('admin.save') }}
                            </button>
                            <a href="{{ route('admin.category.index') }}" class="btn btn-outline-secondary btn-lg"><i
    ...
    <script>
        $(document).ready(function() {
            $('#categoryForm').validate({
                ...
                messages: {
                    name: {
                        required: "{{ __('admin.val_category_name_required') }}",
