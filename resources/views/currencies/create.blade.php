...
@section('title', __('messages.add_currency'))
...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h4 class="fw-bold mb-1">{{ __('messages.add_currency') }}</h4>
    ...
    <form id="currencyForm" method="POST" action="{{ route('currencies.store') }}" data-validate="true">
        @csrf
        <div class="row g-4">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror"
                                value="{{ old('name') }}" placeholder="{{ __('messages.currency_placeholder_name') }}"
                                required>
                            @error('name')
            ...
            <div class="col-lg-4 col-md-4">
                <div class="card shadow-sm">
                    ...
                    <div class="card-body p-4">
                        <div class="mb-4">
                            <label class="form-label fw-semibold d-block">{{ __('messages.status') }} <span
