...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-1">{{ __('messages.add_customer') }}</h4>
    ...
    <form id="customerForm" method="POST" action="{{ route('customers.store') }}" data-validate="true">
        @csrf
        <div class="row g-4">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" name="name"
                                    ...
                                    placeholder="{{ __('messages.ph_customer_name') }}" required>
                                @error('name')
