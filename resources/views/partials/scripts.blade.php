...
<script>
    ...
    // Global status toggle — pill badge AJAX click
            ...
            success: function(res) {
                if (res.status === 'active') {
                    btn.removeClass('border-danger text-danger').addClass(
                        'border-success text-success').text('{{ __('admin.active') }}');
                } else {
                    btn.removeClass('border-success text-success').addClass(
                        'border-danger text-danger').text('{{ __('admin.inactive') }}');
                }
                btn.prop('disabled', false);
            },
            error: function() {
                btn.prop('disabled', false);
                showAdminToast('{{ __('admin.status_update_failed') }}', 'error');
            }
        });
    });
