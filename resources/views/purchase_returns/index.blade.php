...
@section('content')
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <div>
            <h4 class="fw-bold mb-1">Purchase Returns</h4>
    ...
    <div id="filtersCard" class="d-none mb-4">
        <div class="card shadow-sm">
            <div class="card-header bg-white py-3 border-bottom">
                <h6 class="mb-0 fw-semibold"><i class="bx bx-filter-alt me-2"></i>Filter Purchase Returns</h6>
            </div>
            <div class="card-body p-4">
                <form method="GET" action="{{ route('purchase-returns.index') }}">
                    ...
                    <div class="d-flex justify-content-end gap-2 mt-3">
                        <a href="{{ route('purchase-returns.index') }}" class="btn btn-outline-secondary btn-sm">Reset</a>
