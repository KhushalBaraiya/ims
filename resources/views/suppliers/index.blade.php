                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="search" class="form-control form-control-sm"
                            value="{{ request('search') }}" placeholder="{{ __('messages.ph_search_supplier') }}">
                    </div>
                    <div class="col-md-3">
        ...
        $(document).ready(function() {
            $('#suppliersTable').DataTable({
                ...
                language: {
                    ...
                    emptyTable: '<div style="width:100%;text-align:center;padding:2.5rem 0;"><div class="text-muted" style="display:inline-flex;flex-direction:column;align-items:center;gap:8px;"><i class="bx bx-truck" style="font-size:3rem;opacity:.3;line-height:1;"></i>{{ __('messages.no_records') }}</div></div>',
                    paginate: {
            ...
            $('#bulkDeleteBtn').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (r.isConfirmed) {
                        $.ajax({
                            url: '{{ route('suppliers.bulk-destroy') }}',
                            type: 'DELETE',
                            data: {
                                _token: '{{ csrf_token() }}',
                                ids: ids
