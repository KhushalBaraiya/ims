                ...
                <div class="card-body p-0">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                            <span
                                class="text-muted fw-semibold">{{ __('messages.phone_label') }}</span><span>{{ $supplier->phone }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                            <span
                                class="text-muted fw-semibold">{{ __('messages.th_email') }}</span><span>{{ $supplier->email ?: '-' }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                            <span
                                class="text-muted fw-semibold">{{ __('messages.gst_number') }}</span><code>{{ $supplier->gst_number ?: '-' }}</code>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                            <span
                                class="text-muted fw-semibold">{{ __('messages.city') }}</span><span>{{ $supplier->city ?: '-' }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center px-4 py-3">
                            <span class="text-muted fw-semibold">{{ __('messages.opening_balance') }}</span>
                            <strong>{{ format_currency($supplier->opening_balance ?? 0) }}</strong>
                        </li>
