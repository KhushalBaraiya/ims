...
unset($__errorArgs, $__bag); ?>" id="countryInput"
                                    name="country" placeholder="<?php echo e(__('messages.country')); ?>" type="text"
                                    value="<?php echo e(old('country', 'India')); ?>">
...
unset($__errorArgs, $__bag); ?>" name="currency_id"
                                    id="supplierCurrency">
                                    <option value="">— <?php echo e(__('messages.same_base_currency')); ?> —</option>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        ...
        function autoSelectCurrency() {
            ...
            if (matched) {
                note.innerHTML =
                    '<span class="text-success fw-semibold"><i class="bx bx-check-circle me-1"></i><?php echo e(__('messages.auto_matched_label')); ?>: <strong>' +
                    matchedCode + '</strong> <?php echo e(__('messages.based_on_country')); ?>.</span>';
                // Highlight the select briefly
                sel.classList.add('border-success');
                setTimeout(() => sel.classList.remove('border-success'), 2000);
            } else {
                note.innerHTML = '<span class="text-warning"><?php echo e(__('messages.currency_code_label')); ?> <strong>' +
                    matchedCode +
                    '</strong> <?php echo e(__('messages.not_found_in_db')); ?>.</span>';
            }
        }
