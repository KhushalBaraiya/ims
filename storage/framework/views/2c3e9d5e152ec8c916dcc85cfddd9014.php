        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-header border-bottom bg-white py-3">
                <h6 class="fw-semibold mb-0"><i
                        class="bx bx-file text-primary me-2"></i><?php echo e(__('messages.invoice_info')); ?></h6>
            </div>
            <div class="card-body p-4">

                
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.set_invoice_number')); ?></label>
                    <?php if(isset($sale) && $sale->exists): ?>
                        <input class="form-control fw-bold text-primary bg-light" id="invoice_no" name="invoice_no"
                            readonly type="text" value="<?php echo e($sale->invoice_no); ?>">
                    <?php else: ?>
                        <div class="input-group">
                            <input <?php echo e($isReturned ? 'disabled' : ''); ?> class="form-control fw-semibold" id="invoice_no"
                                name="invoice_no" placeholder="<?php echo e(__('messages.set_invoice_number')); ?>" type="text"
                                value="<?php echo e(old('invoice_no')); ?>">
                            <button <?php echo e($isReturned ? 'disabled' : ''); ?> class="btn btn-outline-primary"
                                id="generateInvoiceNoBtn" title="<?php echo e(__('messages.set_invoice_number_hint')); ?>"
                                type="button">
                                <i class="bx bx-revision"></i>
                            </button>
                        </div>
                        <div class="form-text"><?php echo e(__('messages.set_invoice_number_hint')); ?></div>
                    <?php endif; ?>
                </div>

                
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.set_invoice_date')); ?> <span
                            class="text-danger">*</span></label>
                    <input <?php echo e($isReturned ? 'disabled' : ''); ?>

                        class="form-control flatpickr-date <?php $__errorArgs = ['invoice_date'];
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        value="<?php echo e(old('invoice_date', $sale->invoice_date ?? date('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.customer')); ?> <span
                            class="text-danger">*</span></label>
...
unset($__errorArgs, $__bag); ?>" name="customer_id" required>
                        <option value=""><?php echo e(__('messages.select_customer')); ?></option>
                        <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e(old('customer_id', $sale->customer_id ?? '') == $c->id ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <?php if($isSalesOwn ?? false): ?>
                    <input name="sales_person_id" type="hidden" value="<?php echo e(auth()->id()); ?>">
                <?php else: ?>
                    <div class="mb-3">
                        <label class="form-label fw-semibold"><?php echo e(__('messages.set_sales_person')); ?></label>
                        <select <?php echo e($isReturned ? 'disabled' : ''); ?>

                            class="form-select <?php $__errorArgs = ['sales_person_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="sales_person_id">
                            <option value=""><?php echo e(__('messages.select_sales_person')); ?></option>
                            <?php $__currentLoopData = $salesPersons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option
                                    <?php echo e(old('sales_person_id', $sale->sales_person_id ?? auth()->id()) == $sp->id ? 'selected' : ''); ?>

                                    value="<?php echo e($sp->id); ?>">
                                    <?php echo e($sp->name); ?>

                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
                        <?php $__errorArgs = ['sales_person_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" name="status" required>
                        <?php $__currentLoopData = ['Completed', 'Pending', 'Draft', 'Repair', 'Ordered']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $statusOpt): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e(old('status', $sale->status ?? 'Completed') === $statusOpt ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card shadow-sm">
            ...
            <div class="card-body p-4">
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.payment_method')); ?> <span
                            class="text-danger">*</span></label>
                    <select <?php echo e($isReturned ? 'disabled' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" name="payment_method"
                        required>
                        <option value=""><?php echo e(__('messages.select_method')); ?></option>
                        <option
                            <?php echo e(old('payment_method', $sale->payment_method ?? 'Cash') === 'Cash' ? 'selected' : ''); ?>

                            value="Cash">
                            ?? Cash
                        </option>
                        <option
                            <?php echo e(old('payment_method', $sale->payment_method ?? '') === 'Razorpay' ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" id="paid_amount"
                        ...
                        value="<?php echo e(old('paid_amount', $sale->paid_amount ?? '0.00')); ?>">
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <div class="alert alert-danger d-flex align-items-center mb-3 gap-2 px-3 py-2">
                        <i class="bx bx-error-circle"></i><span><?php echo e($message); ?></span>
                    </div>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
                ...
                <div class="table-responsive">
                    ...
                    <div class="text-muted d-flex flex-column align-items-center justify-content-center py-5 text-center"
                        ...
                        <p class="small mb-0"><?php echo e(__('messages.set_no_products_added')); ?></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body p-3">
                        <textarea <?php echo e($isReturned ? 'disabled' : ''); ?> class="form-control" name="notes"
                            placeholder="<?php echo e(__('messages.ph_payment_notes')); ?>" rows="6"><?php echo e(old('notes', $sale->notes ?? '')); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card h-100 shadow-sm">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="d-flex justify-content-between border-bottom py-2">
                            <span class="text-muted small fw-semibold"><?php echo e(__('messages.set_subtotal_rows')); ?></span>
                            <span class="fw-bold"
                        ...
                        <div class="border-bottom py-2">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <div class="form-check form-check-inline mb-0">
                                        <input <?php echo e($isReturned ? 'disabled' : ''); ?>
                                            ...
                                            <?php echo e(old('discount_type', $sale->discount_type ?? 'fixed') === 'fixed' ? 'checked' : ''); ?>

                                            class="form-check-input" id="discType<?php echo e(__('messages.set_fixed')); ?>"
                                            name="discount_type" type="radio" value="fixed">
                                        <label class="form-check-label small"
                                            for="discType<?php echo e(__('messages.set_fixed')); ?>"><?php echo e(__('messages.set_fixed')); ?></label>
                                    </div>
                                    <div class="form-check form-check-inline mb-0">
                                        <input <?php echo e($isReturned ? 'disabled' : ''); ?>

                                            <?php echo e(old('discount_type', $sale->discount_type ?? 'fixed') === 'percentage' ? 'checked' : ''); ?>
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                <span class="text-muted small"
                                    id="discountLabel"><?php echo e(__('messages.set_amount')); ?></span>
                                <input <?php echo e($isReturned ? 'disabled' : ''); ?>
                                    ...
                                    value="<?php echo e(old('discount_value', $sale->discount_value ?? '0.00')); ?>">
                            </div>
                            <input id="discount_amount" name="discount_amount" type="hidden" value="0.00">
                            <div class="mt-1 text-end">
                                <small class="text-danger fw-semibold"
                                    id="lbl_discount_amount">-<?php echo e(optional(current_currency())->symbol ?? '?'); ?>0.00</small>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <input <?php echo e($isReturned ? 'disabled' : ''); ?>
                                    ...
                                    type="number"
                                    value="<?php echo e(old('tax_percentage', $sale->tax_percentage ?? '0.00')); ?>">
                                <span class="text-muted small">%</span>
                            </div>
                        </div>
                        <input id="tax_amount" name="tax_amount" type="hidden" value="0.00">
                        <div class="d-flex justify-content-between border-bottom py-1">
                            <span class="text-muted small">Tax <?php echo e(__('messages.set_amount')); ?></span>
                        ...
                        <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                            ...
                            <input <?php echo e($isReturned ? 'disabled' : ''); ?> class="form-control form-control-sm text-end"
                                ...
                                value="<?php echo e(old('shipping_amount', $sale->shipping_amount ?? '0.00')); ?>">
                        </div>
                        ...
                        <div class="row g-2 mt-1">
                            <div class="col-6">
                                <div
                                    ...
                                    <div class="text-danger small fw-semibold"><?php echo e(__('messages.due_amount')); ?></div>
                            ...
                            <div class="col-6">
                                <div
                                    ...
                                    <div class="text-success small fw-semibold"><?php echo e(__('messages.set_change_return')); ?>
        ...
        <div class="d-flex justify-content-end mt-4 gap-2">
            <a class="btn btn-outline-secondary" href="<?php echo e(route('sales.index')); ?>">
            ...
            <?php endif; ?>
            <?php if(!isset($sale) || !$sale->exists): ?>
                <button <?php echo e($isReturned ? 'disabled' : ''); ?> class="btn btn-outline-primary" id="btnSaveDraft"
                    type="button">
                    <i class="bx bx-file me-1"></i> <?php echo e(__('messages.set_save_as_draft')); ?>

                </button>
            <?php endif; ?>
            <button <?php echo e($isReturned ? 'disabled' : ''); ?> class="btn btn-primary" type="submit">
                <i class="bx bx-save me-1"></i>
                <?php echo e(isset($sale) ? 'Update Invoice' : 'Generate Invoice'); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            ...
            const showOutOfStock = <?php echo e($showOutOfStock ? 'true' : 'false'); ?>;
            const sym = '<?php echo e(addslashes(optional(current_currency())->symbol ?? '?')); ?>';

            function fmt(n) {
                return sym + parseFloat(n).to<?php echo e(__('messages.set_fixed')); ?>(2);
            }

            // -- Auto-generate Invoice No on page load -------------------------
            <?php if(!isset($sale) || !$sale->exists): ?>
                (function autoFillInvoiceNo() {
                    $.get("<?php echo e(route('sales.generate-invoice-no')); ?>", function(res) {
                ...
                <?php $__currentLoopData = old('items', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oldIndex => $oldItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <?php if($oldProduct): ?>
                        addProductRow({
                            ...
                            stock: parseFloat("<?php echo e($oldProduct->stock->quantity ?? 0); ?>"),
                            price: parseFloat(
                                "<?php echo e(old('items.' . $oldIndex . '.unit_price', $oldProduct->selling_price)); ?>"
                            ),
                            taxAmt: parseFloat("<?php echo e(old('items.' . $oldIndex . '.tax_amount', 0)); ?>"),
                            discAmt: parseFloat(
                    ...
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php elseif(isset($sale) && $sale->items->count() > 0): ?>
                ...
                <?php $__currentLoopData = $sale->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    addProductRow({
                        ...
                        stock: parseFloat(
                            "<?php echo e(($item->product->stock->quantity ?? 0) + $item->quantity); ?>"),
                        price: parseFloat("<?php echo e($item->unit_price); ?>"),
                        taxAmt: parseFloat("<?php echo e($item->tax_amount); ?>"),
                        discAmt: parseFloat("<?php echo e($item->discount_amount); ?>"),
                    ...
                    return $(`
                        <div class="d-flex align-items-center gap-3 py-1" style="${p.out_of_stock ? 'opacity:.6;' : ''}">
                            ...
                            <div class="text-end flex-shrink-0">
                                <div class="fw-bold text-primary" style="font-size:13px;">${itemSym}${parseFloat(p.price).to<?php echo e(__('messages.set_fixed')); ?>(2)}</div>
            ...
            $('#productSelect').on('select2:select', function(e) {
                ...
                // Guard: out of stock
                if (p.out_of_stock) {
                    showAdminToast(`"${p.name}" <?php echo e(__('messages.out_of_stock')); ?>.`, 'warning');
                ...
                const taxAmt = parseFloat(((parseFloat(p.tax_percent) / 100) * priceAfterDiscount)
                    .to<?php echo e(__('messages.set_fixed')); ?>(
                        2));
                addProductRow({
                    id: p.id,
                    name: p.name,
            ...
            function addProductRow(p) {
                ...
                $('#invoiceItemsContainer').append(
                    ...
                    .to<?php echo e(__('messages.set_fixed')); ?>(2) + '">' +
                    '<input type="hidden" name="items[' + rowCount +
                    ...
                    ' sale-stock-badge">' +
                    (stockQty > 0 ? stockQty + ' <?php echo e(__('messages.avail')); ?>.' :
            ...
            $('input[name="discount_type"]').on('change', function() {
                $('#discountLabel').text($(this).val() === 'percentage' ? 'Percentage (%)' :
                    '<?php echo e(__('messages.set_amount')); ?>');
                calculateTotals();
            });
            // Set initial label
            $('#discountLabel').text($('input[name="discount_type"]:checked').val() === 'percentage' ?
                'Percentage (%)' : '<?php echo e(__('messages.set_amount')); ?>');
            ...
            function calculateTotals() {
                ...
                if (discType === 'percentage' && discVal > 100) {
                    ...
                    $('#discount_value').val(subtotal.to<?php echo e(__('messages.set_fixed')); ?>(2));
                    discVal = subtotal;
                ...
                $('#discount_amount').val(discAmt.to<?php echo e(__('messages.set_fixed')); ?>(2));
                $('#lbl_discount_amount').text('-' + fmt(discAmt));

                // Global tax on (subtotal - discount)
                const taxPct = parseFloat($('#tax_percentage').val()) || 0;
                const taxAmt = afterDisc * taxPct / 100;
                $('#tax_amount').val(taxAmt.to<?php echo e(__('messages.set_fixed')); ?>(2));
            ...
            $('#btnAdjustStock').on('click', function() {
                ...
                window.open(`<?php echo e(route('stocks.adjust')); ?>?${params}`, '_blank');
            });
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Linux\Desktop\ims\resources\views/sales/form.blade.php ENDPATH**/ ?>