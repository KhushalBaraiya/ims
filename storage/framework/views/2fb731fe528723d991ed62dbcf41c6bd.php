...
<?php if(session('success')): ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            showAdminToast('<?php echo e(addslashes(session('success'))); ?>', 'success');
        });
    </script>
<?php endif; ?>
<?php if(session('error')): ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            showAdminToast('<?php echo e(addslashes(session('error'))); ?>', 'error');
        });
    </script>
<?php endif; ?>
<?php if(session('warning')): ?>
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            showAdminToast('<?php echo e(addslashes(session('warning'))); ?>', 'warning');
        });
    </script>
<?php endif; ?>
...
<?php if(auth()->guard()->check()): ?>
    ...
    ?>
    <?php if($sessionTimeoutMinutes > 0 && !$viaRemember): ?>
        <script>
            (function() {
                var timeoutMs = <?php echo e($sessionTimeoutMinutes * 60 * 1000); ?>;
                ...
                function resetTimers() {
                    ...
                    logoutTimer = setTimeout(function() {
                        ...
                        window.location.href = '<?php echo e(route('logout.session-expired')); ?>';
                    }, timeoutMs);
                }
                ...
                function showWarning() {
                    ...
                    banner.innerHTML = [
                        ...
                        '<div style="flex:1;">',
                        '<?php echo e(__('messages.session_expiring_in')); ?> <strong id="sessionCountdown">60</strong> <?php echo e(__('messages.session_seconds_suffix')); ?> ',
                        '<a href="javascript:void(0)" onclick="location.reload()" ',
                        'style="color:#fff;text-decoration:underline;"><?php echo e(__('messages.stay_logged_in')); ?></a>',
                        '</div>',
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\Users\Linux\Desktop\ims\resources\views/partials/scripts.blade.php ENDPATH**/ ?>