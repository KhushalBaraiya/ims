...
<?php if($errors->has('stock_error')): ?>
    <div class="alert alert-danger d-flex align-items-center mb-4 gap-2 px-3 py-2">
        ...
        <span><?php echo e($errors->first('stock_error')); ?></span>
    </div>
<?php endif; ?>


<?php if($errors->any() && !$errors->has('stock_error')): ?>
    <div class="alert alert-danger d-flex align-items-center mb-4 gap-2 px-3 py-2">
        <i class="bx bx-error-circle fs-5 flex-shrink-0"></i>
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-header border-bottom bg-white py-3">
                <h6 class="fw-semibold mb-0"><i
                        class="bx bx-info-circle text-primary me-2"></i><?php echo e(__('messages.order_info')); ?></h6>
            </div>
            <div class="card-body p-4">
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.purchase_no_label')); ?> <span
                            class="text-danger">*</span></label>
                    <div class="input-group">
                        <input <?php echo e($isReturned ? 'disabled' : ''); ?> <?php echo e(isset($purchase) ? 'readonly' : ''); ?>

                            class="form-control fw-bold <?php $__errorArgs = ['purchase_no'];
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.purchase_date_field')); ?> <span
                            class="text-danger">*</span></label>
                    <input <?php echo e($isReturned ? 'disabled' : ''); ?>

                        class="form-control flatpickr-date <?php $__errorArgs = ['purchase_date'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                        ...
                        value="<?php echo e(old('purchase_date', $purchase->purchase_date ?? date('Y-m-d'))); ?>">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.supplier_field')); ?> <span
                            class="text-danger">*</span></label>
                    <select <?php echo e($isReturned ? 'disabled' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" id="supplierSelect"
                        name="supplier_id" required>
                        <option value=""><?php echo e(__('messages.select_supplier')); ?></option>
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option <?php echo e(old('supplier_id', $purchase->supplier_id ?? '') == $s->id ? 'selected' : ''); ?>

                                value="<?php echo e($s->id); ?>"
                                data-currency-symbol="<?php echo e(optional($s->currency)->symbol ?? ''); ?>"
                                data-currency-code="<?php echo e(optional($s->currency)->code ?? ''); ?>"
                                data-currency-name="<?php echo e(optional($s->currency)->name ?? ''); ?>"
                                data-currency-rate="<?php echo e(optional($s->currency)->exchange_rate ?? ''); ?>"
                                data-currency-id="<?php echo e(optional($s->currency)->id ?? ''); ?>">
                                <?php echo e($s->name); ?> <?php echo e($s->phone ? '(' . $s->phone . ')' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.reference_po_field')); ?></label>
                    <input <?php echo e($isReturned ? 'disabled' : ''); ?> class="form-control" name="reference_no"
                        placeholder="<?php echo e(__('messages.ph_optional_ref')); ?>" type="text"
                        value="<?php echo e(old('reference_no', $purchase->reference_no ?? '')); ?>">
                </div>
                <div class="mb-0">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.status')); ?> <span
                            class="text-danger">*</span></label>
                    <select <?php echo e($isReturned ? 'disabled' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" name="status" required>
                        ...
                        <option <?php echo e(old('status', $purchase->status ?? 'received') === 'received' ? 'selected' : ''); ?>

                            value="received">
                            Received</option>
                        <option <?php echo e(old('status', $purchase->status ?? '') === 'pending' ? 'selected' : ''); ?>

                            value="pending">
                            Pending</option>
                        <option <?php echo e(old('status', $purchase->status ?? '') === 'ordered' ? 'selected' : ''); ?>

                            value="ordered">
                            Ordered</option>
                        <option <?php echo e(old('status', $purchase->status ?? '') === 'draft' ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="card shadow-sm">
            <div class="card-header border-bottom bg-white py-3">
                <h6 class="fw-semibold mb-0"><i
                        class="bx bx-credit-card text-success me-2"></i><?php echo e(__('messages.payment_details')); ?></h6>
            </div>
            <div class="card-body p-4">
                <div class="mb-3">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.payment_method_field')); ?> <span
                            class="text-danger">*</span></label>
                    <select <?php echo e($isReturned ? 'disabled' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" name="payment_method"
                        required>
                        <option value=""><?php echo e(__('messages.select_payment_method')); ?></option>
                        <option
                            <?php echo e(old('payment_method', $purchase->payment_method ?? 'Cash') === 'Cash' ? 'selected' : ''); ?>

                            value="Cash">
                            Cash</option>
                        
                        <option
                            <?php echo e(old('payment_method', $purchase->payment_method ?? '') === 'Razorpay' ? 'selected' : ''); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-0">
                    <label class="form-label fw-semibold"><?php echo e(__('messages.paid_amount_field')); ?> <span
                            class="text-danger">*</span></label>
                    <input <?php echo e($isReturned ? 'disabled' : ''); ?>
...
unset($__errorArgs, $__bag); ?>" id="paid_amount"
                        ...
                        value="<?php echo e(old('paid_amount', $purchase->paid_amount ?? '0.00')); ?>">
                ...
                <div class="mt-3 d-none" id="razorpay_info_box">
                    <div class="rounded-3 p-3"
                        ...
                        <div class="d-flex align-items-center gap-2 mb-2">
                            ...
                            <strong
                                style="color:#4f46e5;font-size:.85rem;"><?php echo e(__('messages.secure_razorpay')); ?></strong>
                        </div>
                        ...
                        <div class="d-flex align-items-center gap-3 mt-2 pt-2" style="border-top:1px dashed #c7d2fe;">
                            <span class="d-flex align-items-center gap-1" style="font-size:.75rem;color:#6c757d;">
                                ...
                                <?php echo e(__('messages.ssl_badge')); ?>

                            </span>
                            <span class="d-flex align-items-center gap-1" style="font-size:.75rem;color:#6c757d;">
                                <i class="bx bx-check-circle" style="color:#696cff;"></i>
                                <?php echo e(__('messages.pci_badge')); ?>

                            </span>
                            <span class="d-flex align-items-center gap-1" style="font-size:.75rem;color:#6c757d;">
                                <i class="bx bx-credit-card" style="color:#696cff;"></i>
                                <?php echo e(__('messages.cards_upi_badge')); ?>
...
unset($__errorArgs, $__bag); ?>
                ...
                <input type="hidden" id="purchase_exchange_rate" name="exchange_rate"
                    value="<?php echo e(old('exchange_rate', $purchase->exchange_rate ?? 1)); ?>">
                <input type="hidden" id="purchase_currency_id" name="currency_id"
                    value="<?php echo e(old('currency_id', $purchase->currency_id ?? '')); ?>">
            </div>
        </div>
    ...
    <div class="col-lg-9">
        ...
        <div class="card mb-4 shadow-sm">
            <div class="card-header border-bottom bg-white py-3">
                <h6 class="fw-semibold mb-0"><i
                        class="bx bx-search text-primary me-2"></i><?php echo e(__('messages.add_products_to_order')); ?></h6>
            </div>
            <div class="card-body p-4">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4">
                    <select id="productSelect" data-no-select2="1" <?php echo e($isReturned ? 'disabled' : ''); ?>
                ...
                <div class="text-muted d-flex flex-column align-items-center justify-content-center py-5 text-center w-100"
                    ...
                    <p class="small mb-0"><?php echo e(__('messages.no_products_added_msg')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-4">
            <div class="col-md-6">
                <div class="card h-100 shadow-sm">
                    <div class="card-header border-bottom bg-white py-3">
                        <h6 class="fw-semibold mb-0"><?php echo e(__('messages.order_notes')); ?></h6>
                    </div>
                    <div class="card-body p-3">
                        <textarea <?php echo e($isReturned ? 'disabled' : ''); ?> class="form-control" name="notes"
                            placeholder="<?php echo e(__('messages.ph_delivery_instructions')); ?>" rows="6"><?php echo e(old('notes', $purchase->notes ?? '')); ?></textarea>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="card h-100 shadow-sm">
                    <div class="card-header border-bottom bg-white py-3">
                        <h6 class="fw-semibold mb-0"><?php echo e(__('messages.calculation_summary')); ?></h6>
                    </div>
                    <div class="card-body p-4">
                        <div class="d-flex justify-content-between border-bottom py-2">
                            <span class="text-muted small fw-semibold"><?php echo e(__('messages.subtotal')); ?></span>
                            <span class="fw-bold"
                                id="sum_subtotal"><?php echo e(optional(current_currency())->symbol ?? '₹'); ?>0.00</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                            <span class="text-muted small fw-semibold"><?php echo e(__('messages.total_discount_lbl')); ?></span>
                            <input id="discount_amount" name="discount_amount" type="hidden"
                                value="<?php echo e(old('discount_amount', $purchase->discount_amount ?? '0.00')); ?>">
                            <span class="fw-bold text-danger"
                                id="lbl_discount_amount"><?php echo e(optional(current_currency())->symbol ?? '₹'); ?>0.00</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                            <span class="text-muted small fw-semibold"><?php echo e(__('messages.total_tax_lbl')); ?></span>
                            <input id="tax_amount" name="tax_amount" type="hidden"
                                value="<?php echo e(old('tax_amount', $purchase->tax_amount ?? '0.00')); ?>">
                            <span class="fw-bold text-success"
                                id="lbl_tax_amount"><?php echo e(optional(current_currency())->symbol ?? '₹'); ?>0.00</span>
                        </div>
                        <div class="d-flex justify-content-between align-items-center border-bottom py-2">
                            <span class="text-muted small fw-semibold"><?php echo e(__('messages.shipping_plus')); ?></span>
                            <input <?php echo e($isReturned ? 'disabled' : ''); ?> class="form-control form-control-sm text-end"
                                id="shipping_amount" min="0" name="shipping_amount" step="0.01"
                                style="width:120px;" type="number"
                                value="<?php echo e(old('shipping_amount', $purchase->shipping_amount ?? '0.00')); ?>">
                        </div>
                        <div class="d-flex justify-content-between border-bottom py-2">
                            <span class="fw-bold"><?php echo e(__('messages.grand_total')); ?></span>
                            <span class="fw-bold text-primary fs-6"
                                id="sum_grandtotal"><?php echo e(optional(current_currency())->symbol ?? '₹'); ?>0.00</span>
                        </div>
                        <div class="row g-2 mt-1">
                            <div class="col-6">
                                <div
                                    class="bg-danger border-danger rounded border border-opacity-25 bg-opacity-10 p-2 text-center">
                                    <div class="text-danger small fw-semibold"><?php echo e(__('messages.balance_due')); ?></div>
                                    <div class="text-danger fw-bold" id="sum_due">
                                        <?php echo e(optional(current_currency())->symbol ?? '₹'); ?>0.00</div>
                                </div>
                            </div>
                            <div class="col-6">
                                <div
                                    class="bg-success border-success rounded border border-opacity-25 bg-opacity-10 p-2 text-center">
                                    <div class="text-success small fw-semibold"><?php echo e(__('messages.overpaid_lbl')); ?>
        ...
        <div class="d-flex justify-content-end mt-4 gap-2">
            <a class="btn btn-outline-secondary" href="<?php echo e(route('purchases.index')); ?>">
                <i class="bx bx-x me-1"></i> <?php echo e(__('messages.cancel')); ?>

            </a>
            <?php if((!isset($purchase) || !$purchase->exists) && !$isReturned): ?>
                <button class="btn btn-outline-primary" id="btnSaveDraft" type="button">
                    <i class="bx bx-file me-1"></i> <?php echo e(__('messages.save_as_draft')); ?>

                </button>
            <?php endif; ?>
            
            <button <?php echo e($isReturned ? 'disabled' : ''); ?> class="btn btn-primary" id="btnSavePurchase" type="submit">
                <i class="bx bx-save me-1"></i>
                <?php echo e(isset($purchase) && $purchase->exists ? 'Update Purchase Order' : 'Save Purchase Order'); ?>

            </button>
            
            <?php if(!isset($purchase) || !$purchase->exists): ?>
                <button class="btn d-none position-relative overflow-hidden" id="btnPayRazorpay" type="button"
                    ...
                    <?php echo e(__('messages.pay_via_razorpay')); ?>
                    ...
                    <span class="position-absolute top-0 end-0 translate-middle badge rounded-pill bg-success"
                        ...
                        <?php echo e(__('messages.secured_badge')); ?>
...
<?php $__env->startPush('scripts'); ?>
    <script>
        $(document).ready(function() {
            let rowCount = 0;
            const isReturned = <?php echo e($isReturned ? 'true' : 'false'); ?>;

            // ── Auto-generate Purchase No on page load ────────────────────────
            <?php if(!isset($purchase) || !$purchase->exists): ?>
                function autoFillPurchaseNo() {
                    $.ajax({
                        url: "<?php echo e(route('purchases.generate-purchase-no')); ?>",
                        type: 'GET',
            ...
            let currencySymbol = '<?php echo e(addslashes(optional(current_currency())->symbol ?? '₹')); ?>';
            // On edit, initialize from stored exchange rate so re-pricing math is correct
            let activeCurrencyExchangeRate =
                <?php echo e((float) ($purchase->exchange_rate ?? (optional(current_currency())->exchange_rate ?? 1))); ?>;
            ...
            function applyNewCurrency(symbol, code, name, rate, isDefault, currencyId) {
                ...
                const defaultCode =
                    '<?php echo e(optional(\App\Models\Currency::where('is_default', true)->first())->code ?? 'INR'); ?>';
                if (newRate !== 1) {
                    $('#supplierCurrencyNote').text('1 ' + defaultCode + ' = ' + newRate.toFixed(4) + ' ' + code);
                } else {
                    $('#supplierCurrencyNote').text('<?php echo e(__('messages.same_as_base_currency')); ?>');
                }
            ...
            $('#btnGeneratePurchaseNo').on('click', function() {
                ...
                $.ajax({
                    url: "<?php echo e(route('purchases.generate-no')); ?>",
                    type: 'GET',
            ...
            <?php if(old('items')): ?>
                <?php $__currentLoopData = old('items', []); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $oldIndex => $oldItem): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php
                        $oldProduct = \App\Models\Product::with(['stock'])->find($oldItem['product_id'] ?? null);
                    ?>
                    <?php if($oldProduct): ?>
                        addProductRow({
                            id: "<?php echo e($oldProduct->id); ?>",
                            name: "<?php echo e(addslashes($oldProduct->name)); ?>",
                            sku: "<?php echo e($oldProduct->code); ?>",
                            purchase_price: parseFloat(
                                "<?php echo e(old('items.' . $oldIndex . '.purchase_price', $oldProduct->purchase_price)); ?>"
                            ),
                            tax: 0,
                            discount: 0,
                            qty: parseInt("<?php echo e(old('items.' . $oldIndex . '.quantity', 1)); ?>"),
                            unit: "<?php echo e($oldProduct->unit_code ?? 'PCS'); ?>",
                            image_url: "<?php echo e($oldProduct->image ? asset('uploads/products/' . $oldProduct->image) : 'https://placehold.co/50x50/e2e8f0/94a3b8?text=No+Image'); ?>",
                            discount_amount_raw: parseFloat(
                                "<?php echo e(old('items.' . $oldIndex . '.discount_amount', 0)); ?>"),
                            tax_amount_raw: parseFloat(
                                "<?php echo e(old('items.' . $oldIndex . '.tax_amount', 0)); ?>")
                        });
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php elseif(isset($purchase) && $purchase->items->count() > 0): ?>
                <?php $__currentLoopData = $purchase->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <?php if($item->product): ?>
                        addProductRow({
                            ...
                            name: "<?php echo e(addslashes($item->product->name)); ?>",
                            sku: "<?php echo e($item->product->code ?? ''); ?>",
                            purchase_price: parseFloat("<?php echo e($item->purchase_price); ?>"),
                            tax: parseFloat(
                                "<?php echo e($item->quantity > 0 ? $item->tax_amount / $item->quantity : 0); ?>"
                            ),
                            discount: parseFloat(
                                "<?php echo e($item->quantity > 0 ? $item->discount_amount / $item->quantity : 0); ?>"
                            ),
                            qty: parseInt("<?php echo e($item->quantity); ?>"),
                            unit: "<?php echo e($item->product->unit_code ?? 'PCS'); ?>",
                            image_url: "<?php echo e($item->product->image ? asset('uploads/products/' . $item->product->image) : 'https://placehold.co/50x50/e2e8f0/94a3b8?text=No+Image'); ?>"
                        });
                    <?php endif; ?>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php endif; ?>
            ...
            $('#productSelect').select2({
                theme: 'bootstrap-5',
                width: '100%',
                placeholder: '<?php echo e(__('messages.type_product_sku_barcode')); ?>',
                allowClear: true,
                minimumInputLength: 0,
                ajax: {
                    url: "<?php echo e(route('purchases.search-products')); ?>",
                    dataType: 'json',
                    delay: 200,
                ...
                templateResult: function(p) {
                    ...
                    const stockBadge = parseFloat(p.stock) > 0 ?
                        `<span class="badge bg-success-subtle text-success">${parseFloat(p.stock).toFixed(0)} <?php echo e(__('messages.in_stock')); ?></span>` :
                        `<span class="badge bg-danger-subtle text-danger"><?php echo e(__('messages.out_of_stock')); ?></span>`;
                    return $(`
                ...
                templateSelection: function(p) {
                    if (!p.id) return p.text || '<?php echo e(__('messages.type_product_sku_barcode')); ?>';
                    return $(
                        ...
                        success: function(res) {
                            ...
                            const options = {
                                ...
                                handler: function(response) {
                                    ...
                                    $form.attr('action',
                                        "<?php echo e(route('razorpay.verify-and-store')); ?>"
                                    );
    ...
    <?php endif; ?>
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\Linux\Desktop\ims\resources\views/purchases/form.blade.php ENDPATH**/ ?>