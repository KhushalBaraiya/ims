...
<head>
    ...
    <title>Sales Invoice — <?php echo e($sale->invoice_no); ?></title>
</head>
                                ...
                                <tr>
                                    <td valign="middle">
                                        <table cellpadding="0" cellspacing="0" border="0">
                                            <tr>
                                                <?php if($companyLogo && file_exists(public_path('uploads/settings/' . $companyLogo))): ?>
                                                    <td style="padding-right:12px;vertical-align:middle;">
                                                        <img src="<?php echo e(asset('uploads/settings/' . $companyLogo)); ?>"
                    ...
                    <tr>
                        <td style="padding:32px 40px;background:#ffffff;">
                            ...
                            <p style="font-size:14px;color:#475569;margin:0 0 28px;line-height:1.7;">
                                Dear <strong
                                    style="color:#1e293b;"><?php echo e($sale->customer->name ?? 'Customer'); ?></strong>,<br>
                            ...
                            line-height:38px;font-size:16px;color:#fff;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div style="font-size:12px;color:#166534;line-height:1.5;">
                                                            Paid:
                                                            <strong><?php echo e($sym); ?><?php echo e(number_format($sale->paid_amount, 2)); ?></strong>
                                                            via <strong><?php echo e($sale->payment_method); ?></strong> on
                                                            <?php echo e($sale->updated_at->format('d M Y, h:i A')); ?>
                            ...
                            line-height:38px;font-size:16px;color:#fff;">
                                                    ...
                                                    <td>
                                                        ...
                                                        <div style="font-size:12px;color:#78350f;line-height:1.5;">
                                                            ...
                                                            —
                                                            Balance Due:
                                                            <strong><?php echo e($sym); ?><?php echo e(number_format($sale->due_amount, 2)); ?></strong>.
                        ...
                        color:#94a3b8;margin-bottom:10px;">
                                        ...
                                        <?php if($sale->salesPerson): ?>
                                            <div style="font-size:11px;color:#64748b;">
                                                👤 <?php echo e($sale->salesPerson->name); ?>
                  ...
                  color:#94a3b8;margin-bottom:10px;">
                    ...
                    border:1px solid #e2e8f0;font-size:12px;">
                                ...
                                <?php $__currentLoopData = $sale->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr
                                        style="background:<?php echo e($i % 2 === 0 ? '#ffffff' : '#f8fafc'); ?>;
                   border-top:1px solid #f1f5f9;">
                                        ...
                                        <td align="center"
                                            ...
                                            <div style="font-size:9px;color:#94a3b8;">
                                                <?php echo e($item->product->unit_code ?? 'PCS'); ?></div>
                                        </td>
                                        <td align="right" style="padding:11px 12px;color:#475569;font-size:12px;">
                                            <?php echo e($sym); ?><?php echo e(number_format($item->unit_price, 2)); ?>

                                        </td>
                                        <td align="right"
                                            style="padding:11px 12px;color:#d97706;font-weight:600;font-size:12px;">
                                            +<?php echo e($sym); ?><?php echo e(number_format($item->tax_amount, 2)); ?>

                                        </td>
                                        <td align="right"
                                            style="padding:11px 12px;font-weight:700;color:#1e293b;font-size:12px;">
                                            <?php echo e($sym); ?><?php echo e(number_format($item->total_amount, 2)); ?>
                                        ...
                                        <table width="100%" cellpadding="0" cellspacing="0" border="0"
                                            ...
                                            <tr style="border-bottom:1px solid #f1f5f9;">
                                                ...
                                                <td align="right"
                                                    ...
                                                    <?php echo e($sym); ?><?php echo e(number_format($sale->sub_total, 2)); ?>
                                            ...
                                            <?php if($sale->discount_amount > 0): ?>
                                                <tr style="border-bottom:1px solid #f1f5f9;">
                                                    ...
                                                    <td align="right"
                                                        ...
                                                        −<?php echo e($sym); ?><?php echo e(number_format($sale->discount_amount, 2)); ?>
                                            ...
                                            <?php if($sale->tax_amount > 0): ?>
                                                <tr style="border-bottom:1px solid #f1f5f9;">
                                                    ...
                                                    <td align="right"
                                                        ...
                                                        +<?php echo e($sym); ?><?php echo e(number_format($sale->tax_amount, 2)); ?>
                                            ...
                                            <?php if($sale->shipping_amount > 0): ?>
                                                <tr style="border-bottom:1px solid #f1f5f9;">
                                                    ...
                                                    <td align="right"
                                                        style="padding:9px 16px;font-size:11px;font-weight:700;color:#1e293b;">
                                                        +<?php echo e($sym); ?><?php echo e(number_format($sale->shipping_amount, 2)); ?>
                           ...
                           letter-spacing:.6px;text-transform:uppercase;">
                                                ...
                                                <td align="right"
                                                    ...
                                                    <?php echo e($sym); ?><?php echo e(number_format($sale->grand_total, 2)); ?>
                                            ...
                                            <tr style="border-bottom:1px solid #f1f5f9;">
                                                ...
                                                <td align="right"
                                                    ...
                                                    <?php echo e($sym); ?><?php echo e(number_format($sale->paid_amount, 2)); ?>
                    ...
                    color:<?php echo e($sale->due_amount > 0 ? '#dc2626' : '#16a34a'); ?>;">
                                                    <?php echo e($sym); ?><?php echo e(number_format($sale->due_amount, 2)); ?>
                    ...
                    <tr>
                        <td
                            ...
                            <p style="font-size:10px;color:#94a3b8;margin:0 0 3px;">
                                ...
                                <strong style="color:#696cff;"><?php echo e($companyName); ?></strong>.
                                Please do not reply to this email.
                            </p>
                            <p style="font-size:10px;color:#94a3b8;margin:0;">
                                Generated on <?php echo e(now()->format('d M Y, h:i A')); ?>

                                &middot; <?php echo e($sale->user->name ?? 'System'); ?>
...
<?php /**PATH C:\Users\Linux\Desktop\ims\resources\views/emails/sale-invoice.blade.php ENDPATH**/ ?>