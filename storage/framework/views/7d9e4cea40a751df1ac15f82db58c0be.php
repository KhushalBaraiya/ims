<?php $__env->startSection('title', __('messages.edit_customer') . ' — ' . $customer->name); ?>

<?php $__env->startSection('content'); ?>

    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h4 class="fw-bold mb-1"><?php echo e(__('messages.edit_customer')); ?></h4>
    ...
    <form id="customerForm" method="POST" action="<?php echo e(route('customers.update', $customer->id)); ?>" data-validate="true">
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('alt_phone', $customer->alt_phone)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('gst_number', $customer->gst_number)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                        value="<?php echo e(old('opening_balance', $customer->opening_balance)); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>"
                                    value="<?php echo e(old('pincode', $customer->pincode)); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-lg-4 col-md-4">
                    ...
                    <div class="card-body p-4">
                            ...
                            <div class="d-flex align-items-center gap-3">
                                ...
                                <div class="form-check form-switch mb-0">
                                    <input class="form-check-input" type="checkbox" role="switch" id="statusToggle"
                                        ...
                                        <?php echo e(old('status', $customer->status) === 'active' ? 'checked' : ''); ?>>
                                </div>
                                <span id="statusLabel"
                                    class="fw-semibold <?php echo e(old('status', $customer->status) === 'active' ? 'text-success' : 'text-danger'); ?>">
                                    <?php echo e(old('status', $customer->status) === 'active' ? __('messages.active') : __('messages.inactive')); ?>
                        ...
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary">
                                <i class="bx bx-save me-1"></i> <?php echo e(__('messages.update')); ?>

                            </button>
                            <a href="<?php echo e(route('customers.show', $customer->id)); ?>" class="btn btn-outline-secondary">
                ...
                <div class="card shadow-sm">
                    <div class="card-header bg-white py-3 border-bottom">
                        <h6 class="mb-0 fw-semibold">
                            <i class="bx bx-info-circle me-2 text-secondary"></i><?php echo e(__('messages.information')); ?>
                    ...
                    <div class="card-body p-4">
                        <ul class="list-unstyled mb-0 small">
                            ...
                            <li class="d-flex justify-content-between py-2 border-bottom">
                                <span class="text-muted fw-semibold"><?php echo e(__('messages.th_created')); ?></span>
                                <span><?php echo e($customer->created_at->format('d M Y')); ?></span>
                            </li>
                            <li class="d-flex justify-content-between py-2">
                                <span class="text-muted fw-semibold"><?php echo e(__('messages.updated')); ?></span>
                                <span><?php echo e($customer->updated_at->format('d M Y')); ?></span>
                            </li>
                        </ul>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Linux\Desktop\ims\resources\views/customers/edit.blade.php ENDPATH**/ ?>