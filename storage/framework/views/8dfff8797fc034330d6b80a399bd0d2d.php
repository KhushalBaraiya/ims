<head>
    ...
    <!-- Favicon -->
    <link href="<?php echo e(asset('assets/img/favicon/favicon.ico')); ?>" rel="icon" type="image/x-icon" />
    ...
    <!-- Template Icons -->
    <link href="<?php echo e(asset('assets/vendor/fonts/iconify-icons.css')); ?>" rel="stylesheet" />

    <!-- Core CSS -->
    <link href="<?php echo e(asset('assets/vendor/css/core.css')); ?>" rel="stylesheet" />
    ...
    <link href="<?php echo e(asset('assets/css/admin-responsive.css')); ?>" rel="stylesheet" />
</head>
<?php /**PATH C:\Users\Linux\Desktop\ims\resources\views/partials/head.blade.php ENDPATH**/ ?>