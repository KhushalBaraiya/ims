...
<?php $__env->startSection('content'); ?>
    ...
    <div class="auth-title"><?php echo e(__('messages.welcome_back')); ?> 👋</div>
    <div class="auth-subtitle"><?php echo e(__('messages.sign_in')); ?></div>
    ...
    <form action="<?php echo e(route('login')); ?>" method="POST">
        ...
        <div class="mb-field">
            <label class="form-label-dark" for="email"><?php echo e(__('messages.email_address_label')); ?></label>
            <input autocomplete="email" autofocus class="input-dark <?php $__errorArgs = ['email'];
...
unset($__errorArgs, $__bag); ?>" id="email"
                name="email" placeholder="<?php echo e(__('messages.ph_email_example')); ?>" required type="email"
...
$message = $__bag->first($__errorArgs[0]); ?>
                ...
                <?php if($isLocked): ?>
                    ...
                    <div class="login-alert-banner login-alert-danger mt-3">
                        ...
                        <div class="login-alert-body">
                            <div class="login-alert-title"><?php echo e(__('messages.account_locked')); ?></div>
                            <div class="login-alert-msg">
                                <?php echo e(__('messages.lockout_too_many_attempts')); ?>

                            </div>
                            <div class="lock-countdown-wrap mt-2">
                                <span class="lock-countdown-label"><?php echo e(__('messages.try_again_in')); ?></span>
                    ...
                    <script>
                        (function() {
                            var unlockAt = <?php echo e($lockTs); ?> * 1000;
                ...
                <?php elseif($isWarning): ?>
                    ...
                    <div class="login-alert-banner login-alert-warning mt-3">
                        ...
                        <div class="login-alert-body">
                            <div class="login-alert-title"><?php echo e(__('messages.invalid_credentials_title')); ?></div>
                            <div class="login-alert-msg"><?php echo e($message); ?></div>
                        </div>
                    </div>
                <?php else: ?>
                    ...
                    <div class="login-alert-banner login-alert-danger mt-3">
                        ...
                        <div class="login-alert-body">
                            <div class="login-alert-title"><?php echo e(__('messages.login_failed_title')); ?></div>
                            <div class="login-alert-msg"><?php echo e($message); ?></div>
                        </div>
                    </div>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
        ...
        <div class="mb-field">
            <div class="d-flex justify-content-between align-items-center mb-2">
                <label class="form-label-dark mb-0" for="password"><?php echo e(__('messages.password_label')); ?></label>
                <?php if(Route::has('password.request')): ?>
                    <a class="forgot-link" href="<?php echo e(route('password.request')); ?>"><?php echo e(__('messages.forgot_password')); ?></a>
                <?php endif; ?>
            </div>
            <div class="pw-wrap">
                <input autocomplete="current-password" class="input-dark <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>"
                    id="password" name="password" placeholder="<?php echo e(__('messages.ph_password_dots')); ?>" required
                    type="password" />
...
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
                <div class="field-error"><i class="bx bx-info-circle"></i> <?php echo e($message); ?></div>
            <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
        ...
        <div class="form-meta-row">
            <div class="form-check">
                ...
                <label class="form-check-label" for="remember_me">
                    <?php echo e(__('messages.remember_session')); ?>
        ...
        <button class="btn-submit" type="submit">
            <i class="bx bx-log-in-circle"></i> <?php echo e(__('messages.sign_in')); ?>
    ...
    <div class="demo-credentials-wrap">
        <div class="demo-title"><?php echo e(__('messages.demo_credentials')); ?></div>
        ...
        <div class="demo-user-card">
            ...
            <button class="demo-copy-btn" onclick="fillCredentials('admin@gmail.com', 'Admin@123')" type="button">
                <i class="bx bx-copy"></i> <?php echo e(__('messages.copy')); ?>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Linux\Desktop\ims\resources\views/auth/login.blade.php ENDPATH**/ ?>