...
<?php $__env->startSection('title', __('messages.menu_suppliers')); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h4 class="fw-bold mb-1"><?php echo e(__('messages.menu_suppliers')); ?></h4>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 small">
                    <li class="breadcrumb-item"><a href="<?php echo e(route('dashboard')); ?>"><?php echo e(__('messages.dashboard')); ?></a></li>
                    <li class="breadcrumb-item active"><?php echo e(__('messages.menu_suppliers')); ?></li>
                </ol>
            </nav>
        </div>
        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('suppliers.create')): ?>
            <div class="d-flex gap-2 align-items-center">
                ...
                <?php endif; ?>
                <a href="<?php echo e(route('suppliers.create')); ?>" class="btn btn-outline-primary">
                    <i class="bx bx-plus me-1"></i> <?php echo e(__('messages.add_supplier')); ?>
                ...
                <div class="row g-3 align-items-end">
                    <div class="col-md-5">
                        ...
                        <input type="text" name="search" class="form-control form-control-sm"
                            value="<?php echo e(request('search')); ?>" placeholder="<?php echo e(__('messages.ph_search_supplier')); ?>">
                    </div>
                    <div class="col-md-3">
                    ...
                    <div class="col-md-2 d-flex gap-2">
                        ...
                        <a href="<?php echo e(route('suppliers.index')); ?>" class="btn btn-outline-secondary btn-sm" title="Reset">
        ...
        <div class="col-6 col-md-3">
            <div class="card shadow-sm border-0 h-100">
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    ...
                    <div>
                        <div class="fw-bold fs-4 lh-1 text-warning"><?php echo e($suppliers->count()); ?></div>
                ...
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    ...
                    <div>
                        <div class="fw-bold fs-4 lh-1 text-success" id="statActiveCount">
                            <?php echo e($suppliers->where('status', 'active')->count()); ?>
                ...
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    ...
                    <div>
                        <div class="fw-bold fs-4 lh-1 text-danger" id="statInactiveCount">
                            <?php echo e($suppliers->where('status', 'inactive')->count()); ?>
                ...
                <div class="card-body d-flex align-items-center gap-3 py-3">
                    ...
                    <div>
                        <div class="fw-bold fs-4 lh-1 text-info">
                            <?php echo e($suppliers->sum(fn($s) => $s->purchases->count())); ?>

                        </div>
                        <div class="text-muted small mt-1"><?php echo e(__('messages.total_purchases')); ?></div>
                    </div>
                </div>
            </div>
        </div>
                ...
                <table class="table table-hover align-middle mb-0" id="suppliersTable" style="width:100%">
                    <thead class="table-light">
                        <tr>
                            ...
                            <th class="text-center"><?php echo e(__('messages.total_purchases')); ?></th>
                        ...
                        <?php $__currentLoopData = $suppliers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $supplier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                <td><input type="checkbox" class="form-check-input row-checkbox"
                                        value="<?php echo e($supplier->id); ?>"></td>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <?php if($supplier->company_name): ?>
                                                <small class="d-block text-muted"><?php echo e($supplier->company_name); ?></small>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                <td class="fw-semibold"><?php echo e($supplier->phone); ?></td>
                                <td class="text-muted"><?php echo e($supplier->email ?: '-'); ?></td>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('suppliers.update')): ?>
                                        <button type="button"
                                            class="status-toggle-btn badge rounded-pill border fw-semibold px-3 py-1
                                                <?php echo e($supplier->status === 'active' ? 'border-success text-success' : 'border-danger text-danger'); ?>"
                                            style="background:transparent;cursor:pointer;" data-id="<?php echo e($supplier->id); ?>"
                                ...
                                <td class="text-muted small"><?php echo e($supplier->created_at->format('d M Y')); ?></td>
                                <td class="text-center">
                                    <div class="tbl-action-wrap">
                                        ...
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('suppliers.delete')): ?>
                                            <form id="delete-form-<?php echo e($supplier->id); ?>"
                                                action="<?php echo e(route('suppliers.destroy', $supplier->id)); ?>" method="POST"
                                                class="d-inline" style="display:contents;">
                                                <?php echo csrf_field(); ?> <?php echo method_field('DELETE'); ?>
                                                <button type="button" class="btn btn-sm btn-outline-danger delete-btn"
                                                    data-id="<?php echo e($supplier->id); ?>" data-name="<?php echo e($supplier->name); ?>"
        ...
        $(document).ready(function() {
            $('#suppliersTable').DataTable({
                ...
                language: {
                    ...
                    emptyTable: '<div style="width:100%;text-align:center;padding:2.5rem 0;"><div class="text-muted" style="display:inline-flex;flex-direction:column;align-items:center;gap:8px;"><i class="bx bx-truck" style="font-size:3rem;opacity:.3;line-height:1;"></i><?php echo e(__('messages.no_records')); ?></div></div>',
                    paginate: {
            ...
            $('#bulkDeleteBtn').on('click', function() {
                ...
                Swal.fire({
                    ...
                    if (r.isConfirmed) {
                        $.ajax({
                            url: '<?php echo e(route('suppliers.bulk-destroy')); ?>',
                            type: 'DELETE',
                            data: {
                                _token: '<?php echo e(csrf_token()); ?>',
                                ids: ids
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Linux\Desktop\ims\resources\views/suppliers/index.blade.php ENDPATH**/ ?>