...
<?php $__env->startSection('title', __('messages.wa_edit_template') . ' — ' . $template->name); ?>
    ...
    <div class="d-flex align-items-center justify-content-between mb-4 flex-wrap gap-2">
        <div>
            <h4 class="fw-bold mb-1 d-flex align-items-center gap-2">
                ...
                <?php echo e(__('messages.wa_edit_template')); ?>
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb mb-0 small">
                    ...
                    <li class="breadcrumb-item active"><?php echo e(__('messages.wa_edit_breadcrumb')); ?></li>
                </ol>
            </nav>
        </div>
            ...
            <div class="card shadow-sm">
                <div class="card-header bg-white border-bottom py-3">
                    <h6 class="fw-semibold mb-0">
                        <i class="bx bx-edit text-primary me-2"></i><?php echo e(__('messages.wa_edit_template')); ?>:
